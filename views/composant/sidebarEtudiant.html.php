...
<body class="bg-gray-100">
    ...
    <aside class="w-[17%] bg-gradient-to-b from-accent to-accent-dark text-white flex flex-col p-5 rounded-r-xl shadow-xl border-r border-gray-200">
        ...
        <nav class="mt-8 flex-1 space-y-2">
            <a href="<?=WEBROOB?>?controler=coursEtudiant&page=coursEtudiant" 
            ...
            <a href="<?=WEBROOB?>?controler=listeAbsence&page=listeAbsence" 
               class="flex items-center text-sm py-3 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 group">
                <span class="mr-3 text-lg group-hover:text-secondary">🏠</span>
                <span class="font-medium group-hover:translate-x-1 transition-transform duration-300">Liste des absences</span>
            </a>
            
            <a href="<?=WEBROOB?>?controler=justification&page=listeJustification" 
               class="flex items-center text-sm py-3 px-4 rounded-lg hover:bg-white/20 transition-all duration-300 group">
                <span class="mr-3 text-lg group-hover:text-secondary">🏡</span>
                <span class="font-medium group-hover:translate-x-1 transition-transform duration-300">Liste des justifications</span>
            </a>
        </nav>
