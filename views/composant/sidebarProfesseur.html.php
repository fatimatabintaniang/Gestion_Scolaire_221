...
<body class="bg-gray-100">
    ...
    <aside class="w-[17%] bg-gradient-to-b from-purple-400 to-purple-600 text-white flex flex-col p-5 rounded">
        ...
        <nav class="mt-16 flex-1 space-y-3">
            <a href="<?=WEBROOB?>?controler=coursProfesseur&page=coursProfesseur" class="flex items-center text-sm py-3 px-4 rounded-lg hover:bg-white hover:bg-opacity-20 transition">
